// SpringNumber and SpringVector class definitions
// export { SpringNumber, SpringVector };
...
export class SpringVector {
    constructor({ frequency, halfLife, position, velocity, target }) {
        ...
        this.position = position ? position.copy() : new Vector();
        this.velocity = velocity ? velocity.copy() : new Vector();
        this.target = target ? target.copy() : new Vector();

        this.detX = new Vector();
        this.detV = new Vector();
    }
    ...
    step(deltaTime) {
        ...
        this.detX.add(Vector.mult(this.velocity, deltaTime));
        this.detX.add(Vector.mult(this.target, hhoo));
